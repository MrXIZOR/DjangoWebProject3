    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted', models.DateTimeField(db_index=True, default=datetime.datetime(2020, 5, 24, 10, 31, 58, 729681), verbose_name='Опубликована')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(db_index=True, default=datetime.datetime(2020, 5, 24, 10, 31, 58, 731681), verbose_name='Дата')),
                ('image', models.FileField(default='temp.jpg', upload_to='', verbose_name='Путь к картинке')),
